# Generated by Powerlevel10k configuration wizard on 2021-12-12 at 19:57 EST.
...
# 12h time, angled separators, sharp heads, blurred tails, 1 line, sparse, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=154
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=214
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=232
  ...
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND=15
  # Custom icon.
  ...
  # Google cloud color.
  typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND=10
